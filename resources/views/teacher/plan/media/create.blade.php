...
<div class="bg-white pb-10">
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Form Tambah Media</h1>
    <div class="md:flex md:justify-center md:space-x-8 md:px-14">
      <form action="{{ route('teacherlessonplanmdstore', $id)}}" method="POST" class="w-full max-w-lg">
        @csrf
        @if(session('errors'))
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <select name="type" id="type" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
              <option>Pilih Tipe Media</option>
              <option value="Media">Media</option>
              <option value="Alat dan Bahan">Alat dan Bahan</option>
              <option value="Sumber Belajar">Sumber Belajar</option>
            </select>
          </div>
          <div class="w-full px-3">
            <label class="block dark:text-white uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
            ...
            <input name="media" id="media" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" required>
          </div>
        </div>
