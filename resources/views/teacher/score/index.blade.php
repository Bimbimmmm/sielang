...
<div class="min-h-screen bg-blue-100 py-2">
  ...
  <div class="px-5 mx-auto max-w-7x1">
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Mata Pelajaran Saya</h1>
        ...
        <tbody class="bg-white">
          ...
          <tr class="text-gray-700 text-center">
            ...
            <td class="px-4 py-3 text-sm border">
              <a href="{{ url ('/teacher/studentscore/show', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
