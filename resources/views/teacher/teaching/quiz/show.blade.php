...
<div class="min-h-screen bg-gray-200 py-3">
  ...
  <div class="px-5 mx-auto max-w-7x1">
      ...
      <div class="w-full overflow-x-auto">
        ...
        <div class="flex items-center justify-center mt-10">
          <div class="w-full max-w-md mr-4">
            <form action="{{ route('teacherquizlock', array("$data->id"))}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
              @csrf
              ...
              <div class="mb-6 text-center">
                <label class="block text-gray-700 text-sm font-normal mb-2" for="password">
                  Jika Kuis Sudah Dikunci, Perubahan Sudah Tidak Dapat Dilakukan
                </label>
              </div>
          ...
          <table class="w-full">
            ...
            <tbody class="bg-white">
              ...
              <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                  <p class="text-gray-900 whitespace-no-wrap">
                    <a href="{{ url ('/teacher/class/quiz/collection/show', array("$collection->id" , "$id", "$idt")) }}" class="text-green-600 hover:text-green-400 mr-2">
                      <i class="material-icons-outlined">visibility</i>
                    </a>
                    @if($collection->is_scored == FALSE)
                    <a href="{{ url ('/teacher/class/quiz/collection/destroy', array("$collection->id")) }}" class="text-red-600 hover:text-red-400    ml-2">
                      <i class="material-icons-round">delete_outline</i>
                    </a>
                    @endif
                  </p>
    ...
    <div class="flex items-center justify-center mt-10">
      <div class="w-full max-w-md mr-4">
        <form action="{{ route('teacherquizinactive', array("$data->id", $idt))}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
          @csrf
          <div class="text-gray-800 text-2xl flex justify-center border-b-2 py-2 mb-4">
            NONAKTIFKAN KUIS
          </div>
          <div class="container" id="alertbox">
            ...
            <p>Jika Kuis Telah Dinonaktifkan, Perubahan Sudah Tidak Dapat Dilakukan</p>
          </div>
        </div>
