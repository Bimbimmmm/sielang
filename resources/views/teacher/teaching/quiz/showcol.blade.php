...
<div class="min-h-screen bg-gray-200 py-3">
  <a href="/teacher/class/quiz/show/{{$idq}}/{{$idt}}">
  ...
  <div class="px-5 mx-auto max-w-7x1">
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Detail Pengumpulan Kuis</h1>
      ...
      <div class="w-full overflow-x-auto">
        <table class="w-full">
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">Tanggal Pengumpulan Kuis</td>
            ...
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">Skor Kuis</td>
  ...
  <div class="md:flex md:justify-center md:space-x-8 md:px-14 bg-white mt-10">
    <form action="{{ route('teacherquizcolscore', array($data->id, $idq, $idt))}}" method="POST" class="w-full max-w-lg mt-10">
