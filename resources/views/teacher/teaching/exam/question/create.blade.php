...
<div class="min-h-screen bg-white pb-10">
  <div class="px-5 mx-auto max-w-7x1">
    <a href="/teacher/class/exam/show/{{$id}}/{{$idt}}">
    ...
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Form Buat Soal Ujian</h1>
    <div class="md:flex md:justify-center md:space-x-8 md:px-14">
      <form action="{{ route('teacherexamstorequestion', array("$id","$idt"))}}" method="POST" class="w-full max-w-lg" enctype="multipart/form-data">
        @csrf
        @if(session('errors'))
