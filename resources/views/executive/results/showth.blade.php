...
<div class="min-h-screen bg-gray-200 py-2">
  <div class="px-5 mx-auto max-w-7x1">
    <a href="/executive/result/show/{{$sid}}">
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        ...
        <table class="w-full">
          <thead>
            <tr class="text-md text-center font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
              <th class="px-4 py-3" colspan="7">Detail Hasil Mata Pelajaran</th>
            </tr>
            <tr class="text-md text-center font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border">{{$detail->user->studentPersonalData->name}}</td>
              <td class="px-4 py-3 text-ms border">{{$detail->user->studentPersonalData->student_number}} / {{$detail->user->studentPersonalData->national_student_number}}</td>
              <td class="px-4 py-3 text-ms border">{{$detail->attendance}}</td>
              <td class="px-4 py-3 text-ms border">{{$detail->task}}</td>
              <td class="px-4 py-3 text-ms border">{{$detail->quiz}}</td>
              <td class="px-4 py-3 text-ms border">{{$detail->exam}}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
      ...
      <div class="w-full overflow-x-auto mt-10">
        <table class="w-full">
          <thead>
            <tr class="text-md text-center font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
              <th class="px-4 py-3" colspan="7">Chart Rata-Rata Hasil Mata Pelajaran</th>
            </tr>
          </thead>
        </table>
