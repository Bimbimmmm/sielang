...
<div class="min-h-screen bg-gray-200 py-3">
  ...
  <div class="px-5 mx-auto max-w-7x1">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <tr class="text-gray-700 text-center">
                ...
                <td class="px-4 py-3 text-ms border">
                  <a class="text-blue-500 hover:text-blue-400" href="{{ asset('storage/exam/' . $data->file) }}">{{$data->file}}</a>
                </td>
                @else
    ...
    @if($collection == NULL)
    <div class="px-5 mx-auto max-w-7x1">
      <h1 class="mb-12 text-center text-2xl text-black font-bold">Pengerjaan Ujian</h1>
      <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        <div class="w-full overflow-x-auto">
          <table class="w-full">
            <tbody class="bg-white">
              <tr class="text-gray-700 text-center">
                <td class="px-4 py-3 text-ms border font-semibold">
                  <div class="flex bg-yellow-100 rounded-lg p-4 mb-4 text-sm text-yellow-700" role="alert">
                    ...
                    <div>
                      <span class="font-medium">Peringatan!</span> Pengerjaan Ujian Hanya Dapat Dilakukan 1 (Satu) Kali! Sangat Disarankan Mengerjakan Ujian Menggunakan Perangkat Komputer / Laptop
                    </div>
                  </div>
                </td>
              </tr>
              <tr class="text-gray-700 text-center">
                <form action="{{ route('studentclassexamstartwork', array($id, $idc))}}" method="POST">
                  @csrf
    ...
    @else
    <div class="px-5 mx-auto max-w-7x1">
      <h1 class="mb-12 text-center text-2xl text-black font-bold">Detail Ujian Yang Dikerjakan</h1>
      <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        <div class="w-full overflow-x-auto">
          <table class="w-full">
            <tbody class="bg-white">
              <tr class="text-gray-700 text-center">
                <td class="px-4 py-3 text-ms border font-semibold">Tanggal Pengerjaan Ujian</td>
              ...
              <tr class="text-gray-700 text-center">
                ...
                @else
                <td class="px-4 py-3 text-ms border">Ujian Belum Dinilai Oleh Guru Pengampuh</td>
                @endif
              </tr>
            </tbody>
          </table>
