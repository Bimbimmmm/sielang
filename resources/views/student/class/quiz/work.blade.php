      ...
      <div class="row-span-3">
        <div class="border-b-2 block md:flex">
          ...
          @if($ques->is_multiple_choice == TRUE)
            ...
            @endforeach
          @else
          <input name="answer" id="answer" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="textarea">
          @endif
