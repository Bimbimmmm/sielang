      ...
      <div class="w-full overflow-x-auto">
        <table class="w-full">
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">NIS</td>
              <td class="px-4 py-3 text-ms border font-semibold">:</td>
              <td class="px-4 py-3 text-ms border">{{$data->student_number}}</td>
            </tr>
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">NISN</td>
              <td class="px-4 py-3 text-ms border font-semibold">:</td>
              <td class="px-4 py-3 text-ms border">{{$data->national_student_number}}</td>
            </tr>
            <tr class="text-gray-700 text-center">
            ...
            <tr class="text-gray-700 text-center">
              <td class="px-4 py-3 text-ms border font-semibold">Sekolah</td>
              <td class="px-4 py-3 text-ms border font-semibold">:</td>
