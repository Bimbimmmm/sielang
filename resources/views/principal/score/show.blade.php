...
<div class="min-h-screen bg-gray-200 py-2">
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <h1 class="mb-12 text-center text-4xl text-black font-bold">Data Mata Pelajaran Bawahan Saya</h1>
        ...
        <table class="w-full">
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border">
                @if($check > 0)
                <a href="/principal/studentscore/print/{{$data->id}}">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border font-semibold">
                <a href="{{ url ('/principal/studentscore/show/student', array("$student->id", "$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
