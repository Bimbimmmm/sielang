...
<div class="min-h-screen bg-blue-100 py-2">
  ...
  <div class="px-5 mx-auto max-w-7x1">
    <h1 class="mb-12 text-center text-3xl text-black font-bold">Rencana Pelaksanaan Pembelajaran Bawahan</h1>
      ...
      <table class="w-full">
        <thead>
          <tr class="text-md text-center font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
            ...
            <th class="px-4 py-3">Tipe - Pertemuan Ke</th>
        ...
        <tbody class="bg-white">
          ...
          <tr class="text-gray-700 text-center">
            ...
            <td class="px-4 py-3 text-sm border">{{$data->type}} - {{$data->meeting}}</td>
            <td class="px-4 py-3 text-sm border">
              <span class="inline-block rounded-full text-white bg-yellow-500 px-2 py-1 text-xs font-bold mr-3">Belum Diterima</span>
            </td>
            <td class="px-4 py-3 text-sm border">
              <a href="{{ url ('/principal/lessonplan/show', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
