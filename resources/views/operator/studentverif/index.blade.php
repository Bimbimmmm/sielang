...
<div class="container mx-auto px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl text-center leading-tight">AKUN SISWA YANG BELUM DIVERIFIKASI</h2>
    </div>
...
<tbody>
  ...
  <tr>
    @if($data->student_personal_data_id != null)
    ...
    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
      <div class="flex items-center">
        <div class="ml-3">
          <p class="text-gray-900 whitespace-no-wrap">
            {{$data->studentPersonalData->national_student_number}}
          </p>
        </div>
      </div>
    </td>
    ...
    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
      <a href="{{ url ('/operator/users/studentverif', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
