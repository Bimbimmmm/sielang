...
class Usrnew extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      ...
      Schema::create('users', function (Blueprint $table) {
          ...
          $table->uuid('executive_personal_data_id')->nullable();
          $table->foreign('executive_personal_data_id')->references('id')->on('executive_personal_data');
          $table->uuid('parent_personal_data_id')->nullable();
          $table->foreign('parent_personal_data_id')->references('id')->on('parent_personal_data');
